# SPSTrust - Contributing

Thanks for your interest in improving SPSTrust! Contributions of all kinds are welcome:
bug reports, feature requests, documentation, and pull requests.

## Before you start

- Search the [existing issues](https://github.com/luigilink/SPSTrust/issues) to avoid duplicates.
- For questions and ideas, open a [discussion](https://github.com/luigilink/SPSTrust/discussions).
- Read the [wiki](https://github.com/luigilink/SPSTrust/wiki) for usage, configuration, and the
  [Release Process](https://github.com/luigilink/SPSTrust/wiki/Release-Process).

## Reporting bugs and requesting features

Use the [issue templates](https://github.com/luigilink/SPSTrust/issues/new/choose) (bug report,
...
- Shared logic lives in the `SPSTrust.Common` module (one function per file under `Public/` or
  `Private/`); the entry script `src/SPSTrust.ps1` orchestrates the run.
- The module `ModuleVersion` in `SPSTrust.Common.psd1` is the single source of truth for the version.
